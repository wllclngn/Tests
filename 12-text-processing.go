...
func main() {
	...
	// data, err := ioutil.ReadFile("f://[4] PROGRAMMING/[02] GO/test34-The Fall of the House of Usher.txt")
	data, err := ioutil.ReadFile("/run/media/mol/BIG MEDIA/[4] PROGRAMMING/[02] GO/test34-The Fall of the House of Usher.txt")
	if err != nil {
